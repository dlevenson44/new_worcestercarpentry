...
function Sidebar() {
  return (
    <div className="sidebar-container">
      ...
      <p className="sidebar-text">    
        Call us today:  <a className="sidebar-link" href="tel:508-523-6797">508-523-6797</a>
      </p>
      <p className="sidebar-text">
        Need masonry work done? <a className="sidebar-link" href="http://worcesterchimneys.com/">Click here!</a>
      </p>
    </div>
  );
}
